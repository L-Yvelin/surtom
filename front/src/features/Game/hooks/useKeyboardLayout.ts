...
interface UseKeyboardLayoutOptions {
  fallback: KeyboardLayouts;
  valueInStorage?: KeyboardLayouts;
  setValueInStorage?: (value: KeyboardLayouts) => void;
}
 ...
 */
export default function useKeyboardLayout({ fallback, valueInStorage, setValueInStorage }: UseKeyboardLayoutOptions): KeyboardLayouts {
  const stored = hasNavigatorKeyboard ? null : valueInStorage;
