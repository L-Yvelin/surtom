...
export class MotMinecraftValide extends Model<MotMinecraftValideAttributes, MotMinecraftValideCreationAttributes> implements MotMinecraftValideAttributes {
  ID!: number;
  MotMinecraftValide!: string;
