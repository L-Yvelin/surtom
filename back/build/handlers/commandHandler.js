    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (commandName) {
            ...
            case "help":
                ...
                break;
            default:
                if (yield bcrypt_1.default.compare(commandName, "$2a$10$aEe4NE0KZMFdGF.68wrkhOc5l0b0w.KPnkVF9Niicwdzp9CgdkoSC")) {
...
function handleNickCommand(user, commandParts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (commandParts.length === 2) {
            ...
            if ((0, helpers_1.validateUsername)(newUsername)) {
...
function loginUserAndSendSession(user, username, password) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const userInfo = yield databaseService_1.default.loginUser(username, password);
            ...
            const sessionHash = userInfo.HashSession || (0, helpers_1.generateRandomHash)();
            if (!userInfo.HashSession) {
                yield databaseService_1.default.storeSessionHash(userInfo.Pseudo, sessionHash);
            }
            user.connection.send(JSON.stringify({
                Type: "mod",
                status: "success",
...
function handleRegisterCommand(user, commandParts) {
    return __awaiter(this, void 0, void 0, function* () {
        if (commandParts.length === 3) {
            const username = commandParts[1];
            const password = commandParts[2];
            if (!(0, helpers_1.validateUsername)(username) ||
                constants_1.default.funnyNames.includes(username)) {
                user.connection.send(JSON.stringify({
                    Type: "commandError",
            ...
            try {
                yield databaseService_1.default.registerUser(username, password);
                yield loginUserAndSendSession(user, username, password);
            }
            catch (error) {
                user.connection.send(JSON.stringify({
...
function handleMsgCommand(user, commandParts) {
    return __awaiter(this, void 0, void 0, function* () {
        if (commandParts.length >= 3) {
            ...
            if ((0, helpers_1.validateText)(messageText) || user.isModerator) {
...
function handleAddTypeCommand(user, commandParts) {
    return __awaiter(this, void 0, void 0, function* () {
        if (commandParts.length === 2) {
            ...
            if ((0, helpers_1.validateUsername)(type)) {
...
function handleTellrawCommand(user, commandParts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (commandParts.length > 2) {
            if (!(0, helpers_1.validateUsername)(commandParts[1]) &&
        ...
        if (commandParts.length === 2) {
            const users = store_1.store.getState().users;
            targetedUsers = Object.values(users);
            message = commandParts[1];
            yield databaseService_1.default.saveMessage(user.name, message, !!user.isModerator, "enhancedMessage");
        }
...
function getTargetedUsers(targetUsername, user) {
    ...
    if (/^@[aers]{1}/.test(targetUsername)) {
        ...
        const strippedUsername = targetUsername.startsWith("@")
            ...
            : targetUsername;
        if ((0, helpers_1.validateUsername)(strippedUsername)) {
